...
from modulos.backupeador import Respaldante
...
if __name__ == "__main__":
    ...
    if listado_dominios:
        ...
        for dominio in lista_dominios:
            listado_usuarios = "{0}/{1}.lst".format(directorio, dominio)
            copy(listado_usuarios, '.')
            matriz_usuarios[dominio] = abrir_listado(listado_usuarios)
    else:
        listador = listar()
        titulador("Obtenemos la lista de dominios")
